# ============================================================
# 1. Load the shared plotting engine and lambda-BM wrapper
# ============================================================
...
# ============================================================
# 3. Draw and save the lambda-BM comparison
# ============================================================

lambda_bm_r2 <- plot_lambda_bm_r2_comparison(
  r2_data = r2_data_file,
  delta_fill_limit = 0.05,
  combined_file = file.path(
    comparison_output_dir,
    "R2_lambda_BM_combined.png"
  ),
  detailed_table_file = file.path(
    comparison_output_dir,
    "R2_lambda_BM_detailed.csv"
  ),
  summary_table_file = file.path(
    comparison_output_dir,
    "R2_lambda_BM_summary.csv"
  ),
  width = 6.5,
  height = 9.0,
  combined_width = 8.25,
...
# ============================================================
# 4. Inspect result tables
# ============================================================

View(lambda_bm_r2$detailed_table)
View(lambda_bm_r2$summary_table)
